    ...
    <style>
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			...
			<li class="nav-item active">
				<a class="nav-link" href="https://webappsubmission1.azurewebsites.net/analyze.php">Analisis Gambar<span class="sr-only">(current)</span></a>
			</li>
		</div>
		</nav>
		<main role="main" class="container">
    		<div class="starter-template"> <br><br><br>
				...
				<p class="lead">Berikut hasil analisis gambar yang telah<b> Anda</b> Upload <br> Karakteristik gambar terdapat di kolom response.</p>
